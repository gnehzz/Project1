...
<html lang="en" ng-app="fotmApp">
  <head>
    ...
    <title>Crowdsourcing Form</title>
  ...
  <body>
    ...
    if (isset($_POST['transcribed'])) {
      ...
      <section class="container" ng-controller="formCtrl">
        <article class="row">
          <form class="form-horizontal" id="form" name="fotmForm" id="fotmForm" method="post" ng-keydown="blockEnter($event)" ng-submit="submit($event)">
            <!-- Transcribed text -->
            <div class="col-md-6">
              <div class="fixed">
