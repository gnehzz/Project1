...
var fotmApp = angular.module('fotmApp', ['fotmForm', 'fotmSearch']);
...
fotmForm.controller('formCtrl', ['$scope', function($scope){
	...
	// Function called on the submission of the form
	// It checks if any error is present in the form, and if this is the case, displays a message and prevent the user from submitting
...
fotmSearch.controller('searchCtrl', ['$scope', function($scope){
